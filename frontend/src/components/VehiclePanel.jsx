    ...
    <div>
        ...
        <h3 className='text-2xl font-semibold mb-5'>Choose a Vehicle</h3>
          <div onClick={()=>{
            ...
            <img className='h-9' src="https://www.asaproadworthys.com.au/wp-content/uploads/2021/11/Select.jpeg" alt="" />
          ...
          <div onClick={()=>{
            props.setConfirmRidePanel(true)
          }} className='flex border-2 active:border-black mb-2 rounded-lg p-3 w-full items-center justify-between'>
