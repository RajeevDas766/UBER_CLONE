...
const Captainsignup = () => {
  ...
  return (
    <div>
      ...
      <input 
      className='bg-[#eeeee] mb-6 rounded px-2 py-2 border w-full text-lg placeholder:text-base'
      value={password}
      onChange={(e)=>{
  ...
  <h3 className='text-lg font-medium mb-2'>Vehicle Information</h3>
          ...
          <div className='flex gap-4 mb-7'>
            ...
            <select
              required
              className='bg-[#eeeeee] w-1/2 rounded-lg px-1 py-1 border text-sm placeholder:text-base'
              value={vehicleType}
              onChange={(e) => {
      ...
      <p className='text-center'>Already have a account? <Link to='/captain-login' className='text-blue-600'>Login here</Link></p>
       ...
       <p className='text-[10px] leading-tight'>
        This site is protected by reCAPTCHA and the <span className='underline'>Google Privacy</span> and <span className='underline'>Terms of Service apply</span>.</p>
       </div>
    </div>
    </div>
  )
